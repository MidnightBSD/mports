...
#
# $MidnightBSD: mports/ports-mgmt/portlint/src/portlint.pl,v 1.7 2008/09/13 20:45:03 laffer1 Exp $
...
MidnightBSD	/usr/mports	MidnightBSD	0	0	0	1	0	/usr/local/	1	1	1
EOF
my $osname = `uname -s`;
$osname =~ s/\n$//;
foreach my $i (@osdep) {
