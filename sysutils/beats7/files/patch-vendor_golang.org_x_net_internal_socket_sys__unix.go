--- vendor/golang.org/x/net/internal/socket/sys_unix.go.orig	2022-04-25 22:30:48 UTC
...
@@ -18,12 +20,6 @@ func syscall_getsockopt(s, level, name int, val unsafe
...
@@ -34,10 +30,93 @@ func setsockopt(s uintptr, level, name int, b []byte) 
