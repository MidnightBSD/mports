--- tools/gn/build/gen.py.orig	2026-04-28 21:06:17 UTC
...
@@ -314,7 +322,7 @@ def WriteGenericNinja(path, static_libraries, executab
...
@@ -560,6 +568,9 @@ def WriteGNNinja(path, platform, host, options, args_l
