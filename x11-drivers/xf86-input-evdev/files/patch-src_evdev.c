--- src/evdev.c.orig	2018-05-29 02:33:18 UTC
+++ src/evdev.c
@@ -38,9 +38,13 @@
...
+#endif
 ...
 #include <errno.h>
 #include <fcntl.h>
@@ -226,6 +230,7 @@ EvdevDeviceIsVirtual(const char* devicenode)
 static BOOL
...
@@ -1072,11 +1080,13 @@ EvdevReadInput(InputInfoPtr pInfo)
     do {
...
+            }
             ...
             if (pEvdev->mtdev)
@@ -1486,7 +1496,12 @@ EvdevAddAbsValuatorClass(DeviceIntPtr device, int num_
             continue;
