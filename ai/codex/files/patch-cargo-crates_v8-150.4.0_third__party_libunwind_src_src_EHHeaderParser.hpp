--- cargo-crates/v8-150.4.0/third_party/libunwind/src/src/EHHeaderParser.hpp.orig	2006-07-24 01:21:28 UTC
+++ cargo-crates/v8-150.4.0/third_party/libunwind/src/src/EHHeaderParser.hpp
@@ -161,6 +161,10 @@ size_t EHHeaderParser<A>::getTableEntrySize(uint8_t ta
