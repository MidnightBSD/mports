...
+#if defined(linux) || defined(__MidnightBSD__) || defined(__HAIKU__)|| defined(__EMSCRIPTEN__)||defined(__CYGWIN__)
...
+#if !(defined(LINUX) && defined(__GNUC__) && defined(__i386__)) || !(defined(__MidnightBSD__) && defined(__i386__))
 #undef HAVE_RDTSC
 #endif
 #endif
