...
_LIST_OF_WITH_FEATURES=	bind_now debug debuginfo lto pie relro sanitize ssp testing zeroregs
...
.endif
.if (defined(CONFLICTS_INSTALL) || defined(CONFLICTS)) && !defined(DISABLE_CONFLICTS)
MPORT_CREATE_ARGS+=	-C "${CONFLICTS} ${CONFLICTS_INSTALL}"
.endif
.endif
