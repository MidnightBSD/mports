...
FAKE_MAKEARGS+=	PREFIX=${TRUE_PREFIX} DOCSDIR=${DOCSDIR} KMODDIR=${KMODDIR}
.endif
...
FAKE_MAKEARGS+=	mandir=${FAKE_DESTDIR}${PREFIX}/share/man MANDIR=${FAKE_DESTDIR}${PREFIX}/share/man
.endif
.endif
.endif
