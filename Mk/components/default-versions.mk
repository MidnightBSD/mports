...
.  for lang in APACHE BDB COROSYNC EMACS FIREBIRD FORTRAN FPC GCC GHOSTSCRIPT GL \
	IMAGEMAGICK JAVA LAZARUS LIBRSVG2 LINUX LLVM LUA MYSQL NINJA NODEJS OPENLDAP \
	PERL5 PGSQL PHP PYTHON PYTHON2 PYTHON3 RUBY RUST SAMBA SSL TCLTK VARNISH
...
.  endif
# Possible values: 2.7, 3.9, 3.10, 3.11, 3.12, 3.13, 3.14
PYTHON_DEFAULT?=	3.12
# Possible values: 2.7
PYTHON2_DEFAULT?=	2.7
