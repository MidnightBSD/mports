...
.if defined(LICENSE)
.  if ${LICENSE:MBSD}
DEV_WARNING+=	"LICENSE must not contain BSD, instead use bsd[234]"
.  endif
...
DEV_ERROR+=	"The following options helpers are incorrectly set after bsd.mport.options.mk and are ineffective: ${_BROKEN_OPTIONS_HELPERS}"
.endif
