...
# EMACS_LIBDIR_WITH_VER:      Library directory without ${PREFIX} including version (e.g. share/emacs/31.1)
...
# EMACS_VER:                  Emacs version (e.g. 31.1)
# EMACS_VERSION_SITE_LISPDIR: Include version (e.g. share/emacs/31.1/site-lisp)
#-------------------------------------------------------------------------------
#
