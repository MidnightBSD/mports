...
_JAVA_PORT_FREEBSD_OPENJDK_JDK_24_INFO=	PORT=java/openjdk24-bin			HOME=${LOCALBASE}/openjdk24 \
											VERSION=24	OS=freebsd	VENDOR=openjdk
...
.		if defined(JAVA_VERSION)
_JAVA_VERSION=	${JAVA_VERSION:S/^1.8+/1.8 11+/:S/^1.7/7/:S/^1.8/8/:S/^7+/7 8+/:S/^8+/8 11+/:S/^11+/11 13+/:S/^13+/13 17+/:S/^17+/17 18+/:S/^18+/18 19+/:S/^19+/19 20+/:S/^20+/20 21+/:S/^21+/21 22+/:S/^22+/22 23+/:S/^23+/23 24+/:S/^24+/24 25+/:S/^25+/25/}
.		else
