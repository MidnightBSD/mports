...
# ex:ts=4
#
# $MidnightBSD: mports/Mk/extensions/gecko.mk,v 1.2 2009/06/29 14:56:26 laffer1 Exp $
...
.if defined(_POSTMKINCLUDED) && !defined(Gecko_Post_Include)

# Please make sure all changes to this file are passed through the maintainer.
Gecko_Include_MAINTAINER=	ports@MidnightBSD.org
Gecko_Post_Include=			gecko.mk
...
.if ${ARCH}!="sparc64"
_GECKO_ALL=	browser browser3 nvu seamonkey thunderbird xulrunner flock browser35
.endif
_GECKO_ALL+=	mozilla
