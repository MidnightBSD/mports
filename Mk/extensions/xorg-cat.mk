...
.include "${MPORTEXTENSIONS}/meson.mk"
...
.include "${MPORTEXTENSIONS}/autoreconf.mk"
.    endif
.  else
...
libtool_ARGS?=	# empty
.include "${MPORTEXTENSIONS}/libtool.mk"
...
.    endif
.    if !defined(NOFONT)
.include "${MPORTEXTENSIONS}/fonts.mk"
...
.  elif ${_XORG_CAT} == lib
.include "${MPORTEXTENSIONS}/pathfix.mk"
.    if ${_XORG_BUILDSYS} == meson
...
.include "${MPORTEXTENSIONS}/xorg.mk"
.  endif
