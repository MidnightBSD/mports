...
<title>CVS log for ports/ftp/wget/files/patch-src__gnutls.c</title>
...
<h1>CVS log for ports/ftp/wget/files/patch-src__gnutls.c</h1>
<link rel="stylesheet" type="text/css" href="/layout/css/cvsweb.css" />
<p>
 <a href="./#patch-src__gnutls.c"><img src="/gifs/back.gif" alt="[BACK]" border="0" width="20" height="22" /></a> <b>Up to  <a href="/cgi/cvsweb.cgi/#dirlist">[FreeBSD]</a> / <a href="/cgi/cvsweb.cgi/ports/#dirlist">ports</a> / <a href="/cgi/cvsweb.cgi/ports/ftp/#dirlist">ftp</a> / <a href="/cgi/cvsweb.cgi/ports/ftp/wget/#dirlist">wget</a> / <a href="/cgi/cvsweb.cgi/ports/ftp/wget/files/#dirlist">files</a></b>
</p>
<p>
...
<hr />
<a name="rev1.1"></a><a name="RELEASE_8_1_0"></a><a name="RELEASE_7_3_0"></a><a name="HEAD"></a><a name="MAIN"></a>
 Revision <b>1.1</b>: <a href="/cgi/cvsweb.cgi/~checkout~/ports/ftp/wget/files/patch-src__gnutls.c?rev=1.1;content-type=text%2Fplain" class="download-link">download</a> - view: <a href="patch-src__gnutls.c?rev=1.1;content-type=text%2Fplain" class="display-link">text</a>, <a href="patch-src__gnutls.c?rev=1.1;content-type=text%2Fx-cvsweb-markup" class="display-link">markup</a>, <a href="patch-src__gnutls.c?annotate=1.1">annotated</a> - <a href="patch-src__gnutls.c?r1=1.1#rev1.1">select&nbsp;for&nbsp;diffs</a><br />
<i>Sat Feb 20 19:59:59 2010 UTC</i> (4 months, 3 weeks ago) by <i>vd</i><br />
Branches: <a href="./patch-src__gnutls.c?only_with_tag=MAIN">MAIN</a><br />
CVS tags: <a href="./patch-src__gnutls.c?only_with_tag=RELEASE_8_1_0">RELEASE_8_1_0</a>,
<a href="./patch-src__gnutls.c?only_with_tag=RELEASE_7_3_0">RELEASE_7_3_0</a>,
<a href="./patch-src__gnutls.c?only_with_tag=HEAD">HEAD</a><br />
<pre class="log">
ftp/wget: Fix build with GNUTLS

PR:		<a href="http://www.FreeBSD.org/cgi/query-pr.cgi?pr=144144">ports/144144</a>
Submitted by:	Sunpoet Po-Chuan Hsieh &lt;<a href="mailto:sunpoet@sunpoet.net">sunpoet@sunpoet.net</a>&gt;
Feature safe:	yes
</pre>
<hr />
<form method="get" action="/cgi/cvsweb.cgi/ports/ftp/wget/files/patch-src__gnutls.c.diff" id="diff_select">
<fieldset>
...
<option value="1.1:RELEASE_8_1_0">RELEASE_8_1_0</option>
...
<form method="get" action="/cgi/cvsweb.cgi/ports/ftp/wget/files/patch-src__gnutls.c">
<fieldset>
